  ...
  <div class="chart-wrapper">
      ...
      <b-col xs="12">
        <div class="token-price-wrapper d-flex flex-column flex-md-row">
          <div class="mb-2 mb-md-0 mr-2 d-flex align-items-center">
            ...
            <div v-if="!isCurrencyToken(tokenDetails)" class="d-inline-block token-name">
              {{ tokenDetails.name }}:
            </div>
    ...
    <b-row>
      ...
      >
        ...
        <div>
          We do not keep data for this token. If you would like us to start collecting it please
          contact us at
  ...
  export default {
    ...
    methods: {
      ...
      updateLastUpdatedTime() {
        const secondsAfterLastUpdate = Math.round((Date.now() - this.currentPrice.timestamp) / 1000)
      ...
      isCurrencyAndNotRedstoneProvider(details) {
        return (
          !this.provider.toLocaleLowerCase().includes('redstone') && this.isCurrencyToken(details)
        )
      },
