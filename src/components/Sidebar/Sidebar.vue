<template>
  <div class="sidebar-wrapper">
    <nav :class="{ sidebar: true, showSidebar }" style="height: 100%">
      ...
      <ul class="nav">
        <NavLink :activeItem="activeItem" header="Prices" link="/app/tokens" iconName="flaticon-prices" index="tokens"
          isHeader />

        <NavLink :activeItem="activeItem" header="Sources" link="/app/sources" iconName="flaticon-sources"
          index="sources" isHeader />

        <NavLink :activeItem="activeItem" header="Data services" link="/app/data-services" iconName="flaticon-providers"
          index="providers" isHeader />

        <NavLink :activeItem="activeItem" header="Onchain feeds" link="/app/feeds" iconName="flaticon-layers"
          index="feeds" isHeader />
