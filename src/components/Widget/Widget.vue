<template>
  <section
    ...
    ref="widget"
  >
    <h5 v-if="title && typeof title === 'string' && !customHeader" class="title">
      {{ title }}
    </h5>
  ...
  export default {
    ...
    mounted() {
      ...
      if (this.customControls) {
        ...
        collapse &&
          collapse.addEventListener('click', this.changeState.bind(this, null, 'collapse'))
        ...
        fullscreen &&
          fullscreen.addEventListener('click', this.changeState.bind(this, null, 'fullscreen'))
